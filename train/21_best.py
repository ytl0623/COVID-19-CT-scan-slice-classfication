...
if not os.path.isdir('./Checkpoint/best/'):
    os.mkdir('./Checkpoint/best/')
...
def train():
    ...
    for epoch in range(num_epochs):
        ...
        if (epoch + 1) % checkpoint_interval == 0:
            torch.save(model, './Checkpoint/best/model-epoch-{:d}-train.pth'.format(epoch + 1))
    ...
    best_model_name = './Checkpoint/best/model-{:.2f}-best_train_acc.pth'.format(best_acc)
